...
class TestBookingRepository(unittest.TestCase):
    ...
    def setUp(self):
        ...
        member_repository.save(self.member_1)
        member_repository.save(self.member_2)
        ...
        gym_class_repository.save(self.gym_class_1)
        gym_class_repository.save(self.gym_class_2)
        self.booking_1 = booking_repository.Booking(self.member_1, self.gym_class_1, True)
        self.booking_2 = booking_repository.Booking(self.member_2, self.gym_class_2, False)
