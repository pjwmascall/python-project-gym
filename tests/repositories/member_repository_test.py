...
class TestMemberRepository(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_member_1 = Member('Jon', 'Snow', '123 Street Avenue', 'Standard', True)
        self.test_member_2 = Member('Joe', 'Bloggs', '123 Boulevard Crescent', 'Premium', True)

    def test_can_save_member(self):
        member = save(self.test_member_1)
        self.assertEqual(member, self.test_member_1)

    def test_can_select_all_members(self):
        member_1 = save(self.test_member_1)
        member_2 = save(self.test_member_2)
        members = select_all()
    ...
    def test_can_delete_all_members(self):
        save(self.test_member_1)
        save(self.test_member_2)
        delete_all()
        members = select_all()
